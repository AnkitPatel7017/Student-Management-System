...
exports.studentAll = async (req, res) => {
  ...
  exports.getstudentByIdCode = async (req, res) => {
    // console.log(req.body.idcode);
    knex('student').where(
      ...
      .catch(err => {
        res.json({ message: `There was an error creating ${req.body.idcode} student: ${err}` })
      })
  }

  // exports.getstudentByTitle = async (req, res) => {
  //   // console.log(req.body.idcode);
  //   knex('student').where(
